...
header_len = 4*5+(1+LEN_BITS_Y_DC)*4+(1+LEN_HUFFVAL_Y_DC)*4+(1+LEN_BITS_Y_AC)*4+(1+LEN_HUFFVAL_Y_AC)*4;
header_len = header_len+(1+LEN_BITS_C_DC)*4+(1+LEN_HUFFVAL_C_DC)*4+(1+LEN_BITS_C_AC)*4+(1+LEN_HUFFVAL_C_AC)*4;
data_len = length(U_SBYTES_Y)+ length(U_SBYTES_CB)+length(U_SBYTES_CR);
